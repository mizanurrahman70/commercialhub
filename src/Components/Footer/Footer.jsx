        ...
        <footer className="flex flex-col ">
            <div className="flex flex-col items-center justify-around gap-5 bg-sky-50 py-8 md:flex-row md:gap-0">
                <aside className="flex items-center justify-center gap-3 text-xl">
                    ...
                    <p>Commercial<span className='md:text-2xl md:font-semibold text-green-500'>Hub</span></p>
                </aside>
            ...
            <aside className="bg-sky-100 py-5 text-center text-sm">
                <p>&copy; 2024 <span className='text-green-700'>Commercial<span className='md:text-2xl md:font-semibold text-green-500'>Hub</span></span> . All Rights Reserved.</p>
            </aside>
        </footer>
