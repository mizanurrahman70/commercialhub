...
const Profile = () => {
    ...
    return (
        ...
        <div data-aos="flip-up" className="flex flex-col justify-center w-full p-6 shadow-md rounded-xl sm:px-12 bg-gray-900 text-gray-100 mx-auto container my-10">
			<Helmet>
	...
	<div className="space-y-4 text-center divide-y divide-gray-700">
		<div className="my-2 space-y-1">
			<h2 className=" font-semibold sm:text-2xl">Name : {displayName}</h2>
			<h2 className="md:text-xl font-semibold ">Email : {
email}</h2>
